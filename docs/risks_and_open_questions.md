...
6. **Open for Milestone 6 - atomics:** LR.W/SC.W, reservation clearing beyond invalidation hooks, locks, and portable synchronization primitives remain absent.
7. **Deliberate limitation - coherent instruction/data interaction:** L1I remains non-coherent; self-modifying code and coherent DMA are outside scope.
